...
String getCompressedPubKey(String publicKey) {
  ECCurve_secp256k1 curveSecp256k1 = new ECCurve_secp256k1();
  var ecPoint = curveSecp256k1.curve.decodePoint(hexToBytes(publicKey));
  if (ecPoint.y.toBigInteger().isEven) {
    return "02" + ecPoint.x.toBigInteger().toRadixString(16).padLeft(64, "0");
  } else if (ecPoint.y.toBigInteger().isOdd) {
    return "03" + ecPoint.x.toBigInteger().toRadixString(16).padLeft(64, "0");
  }
  return publicKey;
}
