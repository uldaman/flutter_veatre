...
final Future<Database> database = (() async {
  return openDatabase(
    ...
    onCreate: (db, version) async {
      ...
      await db.execute(
        '''CREATE TABLE IF NOT EXISTS $walletTableName (id INTEGER PRIMARY KEY, name TEXT,privateKey TEXT, password TEXT, keystore TEXT, isMain INTEGER, network INTEGER);
        ''',
      );
      await db.execute(
